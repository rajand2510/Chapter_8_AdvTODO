...
const Login = () => {
    ...
    return (
        <div className="flex h-screen">
            {/* Left Side */}
            <div className="hidden lg:flex w-1/2 bg-gradient-to-tr from-red-400 to-[#DC2626] flex-col justify-between p-12 text-white relative overflow-hidden">
                ...
                <div className="z-10">
                    <Link to={"/"} className="flex items-center space-x-2">
                        <ClipboardCheck />
                        <span className="font-bold text-2xl drop-shadow-md">dosphere</span>
                    </Link>
                </div>

                <div className="z-10 p-6">
                    <h2 className="text-4xl font-bold leading-tight drop-shadow-md tracking-tight">
                        Clarity, focus, and peace.
                    </h2>
                    <p className="mt-4 text-lg opacity-80 max-w-md drop-shadow-sm">
